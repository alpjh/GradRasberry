# 1 "/home/jaehyun/build_arm/core/libgcc_udivsi3.S"
...
# 27 "/home/jaehyun/build_arm/core/libgcc_udivsi3.S"
.section .note.GNU-stack,"",%progbits
.previous
# 62 "/home/jaehyun/build_arm/core/libgcc_udivsi3.S"
        .eabi_attribute 25, 1
# 184 "/home/jaehyun/build_arm/core/libgcc_udivsi3.S"
...
# 263 "/home/jaehyun/build_arm/core/libgcc_udivsi3.S"
        .ifc "\regs",""
        ldr\cond pc, [sp], #8
        .else
...
.macro shiftop name, dest, src1, src2, shiftop, shiftreg, tmp
        ...
        \name \dest, \src1, \tmp
.endm
# 309 "/home/jaehyun/build_arm/core/libgcc_udivsi3.S"
.macro ARM_LDIV0 name signed
        ...
        b __aeabi_idiv0
.endm
# 331 "/home/jaehyun/build_arm/core/libgcc_udivsi3.S"
.macro THUMB_LDIV0 name signed
# 362 "/home/jaehyun/build_arm/core/libgcc_udivsi3.S"
        .syntax unified
        .ifc \signed, unsigned
        cbz r0, 1f
        mov r0, #0xffffffff
1:
        ...
        .endif
        b.w __aeabi_idiv0
# 390 "/home/jaehyun/build_arm/core/libgcc_udivsi3.S"
.endm
# 406 "/home/jaehyun/build_arm/core/libgcc_udivsi3.S"
.macro FUNC_END name
        .size __\name, . - __\name
.endm
...
\name:
.endm
# 445 "/home/jaehyun/build_arm/core/libgcc_udivsi3.S"
...
.macro ARM_CALL name
        bl __\name
.endm
# 528 "/home/jaehyun/build_arm/core/libgcc_udivsi3.S"
...
.endm
# 560 "/home/jaehyun/build_arm/core/libgcc_udivsi3.S"
.macro WEAK name
        .weak __\name
.endm
...
result .req r2
curbit .req r3
# 585 "/home/jaehyun/build_arm/core/libgcc_udivsi3.S"
...
1:
        ...
        .endr
# 696 "/home/jaehyun/build_arm/core/libgcc_udivsi3.S"
.endm
...
.macro ARM_DIV2_ORDER divisor, order
        ...
        clz \order, \divisor
        rsb \order, \order, #31
# 726 "/home/jaehyun/build_arm/core/libgcc_udivsi3.S"
.endm
...
.macro ARM_MOD_BODY dividend, divisor, order, spare
        ...
        .endr
# 815 "/home/jaehyun/build_arm/core/libgcc_udivsi3.S"
.endm
...
.udivsi3_skip_div0_test:
        ...
        pop { work }
        bx lr
# 1044 "/home/jaehyun/build_arm/core/libgcc_udivsi3.S"
...
FUNC_START aeabi_uidivmod
        ...
        sub r1, r1, r2
        bx r3
# 1075 "/home/jaehyun/build_arm/core/libgcc_udivsi3.S"
        FUNC_END aeabi_uidivmod
# 1994 "/home/jaehyun/build_arm/core/libgcc_udivsi3.S"
# 1 "/home/jaehyun/dynamorio/core/../third_party/libgcc/arm/ieee754-df.S" 1
# 1995 "/home/jaehyun/build_arm/core/libgcc_udivsi3.S" 2
# 1 "/home/jaehyun/dynamorio/core/../third_party/libgcc/arm/ieee754-sf.S" 1
# 1996 "/home/jaehyun/build_arm/core/libgcc_udivsi3.S" 2
...
.endm
# 1997 "/home/jaehyun/build_arm/core/libgcc_udivsi3.S" 2
